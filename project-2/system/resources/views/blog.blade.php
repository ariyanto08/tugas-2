			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="p-b-63">
							<a href="blog-detail.html" class="hov-img0 how-pos5-parent">
								<img src="{{ url('public') }}/assets/images/blog-05.jpg" alt="IMG-BLOG">
						...
						<div class="p-b-63">
							<a href="blog-detail.html" class="hov-img0 how-pos5-parent">
								<img src="{{ url('public') }}/assets/images/blog-06.jpg" alt="IMG-BLOG">
							...
							<ul>
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="{{ url('public') }}/assets/images/product-min-01.jpg" alt="PRODUCT">
									</a>
								...
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="{{ url('public') }}/assets/images/product-min-02.jpg" alt="PRODUCT">
									</a>
								...
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="{{ url('public') }}/assets/images/product-min-03.jpg" alt="PRODUCT">
									</a>
